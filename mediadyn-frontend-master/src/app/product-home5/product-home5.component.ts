...
@Component({
  selector: 'app-product-home5',
  templateUrl: './product-home5.component.html',
  styleUrls: ['./product-home5.component.css']
})
export class ProductHome5Component implements OnInit {
  title = 'reebok';
  ...
  get() {
    ...
    let that = this;
      this.http.get('https://theenplugapp.com/api/getTriggeredProduct/q5').subscribe(res => {
      console.log('res', res);
      this.display = false;
