...
@Component({
  selector: 'app-product-home2',
  templateUrl: './product-home2.component.html',
  styleUrls: ['./product-home2.component.css']
})
export class ProductHome2Component implements OnInit {
  title = 'reebok';
